...
## Project Structure
    ...
    ├── lingering_shape_dev_93102  # Django project configurations
...
1. Clone this repo and `cd lingering_shape_dev_93102`
...
2. Clone this repo and `cd lingering_shape_dev_93102`
